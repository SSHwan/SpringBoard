...
<div class="col-2"></div>
<div class="col-1 p-3"><h4>답변</h4></div>
...
<input type="submit" value="답변" class="btn btn-outline-secondary btn-sm" formaction="${pageContext.request.contextPath}/article/createReply">&nbsp;&nbsp;
